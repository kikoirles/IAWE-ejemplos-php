      ...
      <div class="row">
        ...
        <div class="col-md-4 right_section_header_top">
          ...
          <div class="float-right">
            <div class="make_appo"> <a class="btn white_btn" href="login.php">.LOG OUT/a> </div>
            <div class="make_appo"> <a class="btn white_btn" href="">.PROFILE</a> </div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="full">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="main_heading text_align_center">
                ...
                <h1 align="left" >ID &nbsp &nbsp &nbsp &nbsp EXISTENCIA &nbsp PRECIO &nbsp &nbsp &nbsp &nbsp &nbsp DESCRIPCION</h1>";
              <!-- introduzco los datos que me ejecuta productos.php -->
             <h1 align="left"><?php include('productos.php') ?> <h1>
        </div>
      </div>
    </div>
  </div>
